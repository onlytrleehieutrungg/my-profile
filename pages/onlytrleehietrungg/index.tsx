                    ...
                    <div className="contact ">
                        <div className="container ">
                            <div className="justify-center gap-2">
                                {/* <h2 className='inline-flex items-center text-4xl text-zinc-200'>contact me {"  "}</h2> */}
                                <Link href={'https://www.facebook.com/rtlee2101.bido/'}>
                                ...
                                <Link href={'https://www.linkedin.com/in/rtlee2101/'} >
                                    <button className="p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                                        <svg className="w-16 h-16 fill-current" role="img" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link href={'https://github.com/onlytrleehieutrungg'}>
                                    <button className="p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="w-16 h-16" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
